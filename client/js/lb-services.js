  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Order.customers.findById() instead.
        "::findById::Order::customers": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Orders/:id/customers/:fk",
          method: "GET"
        },

        // INTERNAL. Use Order.customers.destroyById() instead.
        "::destroyById::Order::customers": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Orders/:id/customers/:fk",
        ...
        // INTERNAL. Use Order.customers.updateById() instead.
        "::updateById::Order::customers": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Orders/:id/customers/:fk",
        ...
        // INTERNAL. Use Order.customers.link() instead.
        "::link::Order::customers": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Orders/:id/customers/rel/:fk",
          method: "PUT"
        },

        // INTERNAL. Use Order.customers.unlink() instead.
        "::unlink::Order::customers": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Orders/:id/customers/rel/:fk",
        ...
        // INTERNAL. Use Order.customers.exists() instead.
        "::exists::Order::customers": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Orders/:id/customers/rel/:fk",
        ...
        // INTERNAL. Use Order.customers() instead.
        "::get::Order::customers": {
          isArray: true,
        ...
        // INTERNAL. Use Order.customers.create() instead.
        "::create::Order::customers": {
          url: urlBase + "/Orders/:id/customers",
          method: "POST"
        },

        // INTERNAL. Use Order.customers.createMany() instead.
        "::createMany::Order::customers": {
          isArray: true,
          url: urlBase + "/Orders/:id/customers",
          method: "POST"
        },

        // INTERNAL. Use Order.customers.destroyAll() instead.
        "::delete::Order::customers": {
          url: urlBase + "/Orders/:id/customers",
          method: "DELETE"
        },

        // INTERNAL. Use Order.customers.count() instead.
        "::count::Order::customers": {
          url: urlBase + "/Orders/:id/customers/count",
          method: "GET"
        },
      }
    );
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Order.customers
     * @header lbServices.Order.customers
     * @object
     * @description
     *
     * The object `Order.customers` groups methods
     * manipulating `Customer` instances related to `Order`.
     *
     * Call {@link lbServices.Order#customers Order.customers()}
     * to query all related instances.
     */
        ...
        R.customers = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::get::Order::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Order.customers#count
         * @methodOf lbServices.Order.customers
         *
         * @description
         *
         * Counts customers of Order.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.customers.count = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::count::Order::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Order.customers#create
         * @methodOf lbServices.Order.customers
         *
         * @description
         *
        ...
        R.customers.create = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::create::Order::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Order.customers#createMany
         * @methodOf lbServices.Order.customers
         *
         * @description
         *
        ...
        R.customers.createMany = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::createMany::Order::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Order.customers#destroyAll
         * @methodOf lbServices.Order.customers
         *
         * @description
         *
        ...
        R.customers.destroyAll = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::delete::Order::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Order.customers#destroyById
         * @methodOf lbServices.Order.customers
         *
         * @description
         *
        ...
        R.customers.destroyById = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::destroyById::Order::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Order.customers#exists
         * @methodOf lbServices.Order.customers
         *
         * @description
         *
        ...
        R.customers.exists = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::exists::Order::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Order.customers#findById
         * @methodOf lbServices.Order.customers
         *
         * @description
         *
        ...
        R.customers.findById = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::findById::Order::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Order.customers#link
         * @methodOf lbServices.Order.customers
         *
         * @description
         *
        ...
        R.customers.link = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::link::Order::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Order.customers#unlink
         * @methodOf lbServices.Order.customers
         *
         * @description
         *
        ...
        R.customers.unlink = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::unlink::Order::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Order.customers#updateById
         * @methodOf lbServices.Order.customers
         *
         * @description
         *
        ...
        R.customers.updateById = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::updateById::Order::customers"];
          return action.apply(R, arguments);
        };
